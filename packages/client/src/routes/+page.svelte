...
<div class="flex flex-col items-center justify-center h-screen mt-n50">
	<h1 class="text-7xl text-[#a413f2] font-bold outline-none my-8">
		<div
			style="background: linear-gradient(to right, #9737e6, #C55BD5); -webkit-background-clip: text; -webkit-text-fill-color: transparent; animation: gradient 5s ease infinite;"
		>
			BREMA WALLET
		</div>
	</h1>
