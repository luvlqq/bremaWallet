...
<form on:submit={handleSubmit}>
	<div class="flex items-center justify-center flex-col mt-10">
		...
		<input
			...
			bind:value={password}
		/>
		<label for="passwordConfirm" class="my-2 mt-4">Confirm your password:</label>
		<input
			type="password"
			placeholder="password"
			class="input input-bordered input-primary w-full max-w-xs"
		...
		{/if}
		<a href="/auth" class="my-5 hover:bg-purple-500 text-purple-700 font-semibold hover:text-white"
			>Log In</a
		>
		<button
			type="submit"
