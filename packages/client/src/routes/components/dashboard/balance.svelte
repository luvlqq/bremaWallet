...
<div class="balance-wrapper">
	<div class="balance">
		...
		<button
			type="button"
			class="my-4 text-black bg-white hover:bg-purple-800 hover:text-white focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 w-48 h-12"
			...
			<div class="fixed top-0 left-0 w-full h-full flex justify-center items-center z-20">
				<div class="bg-white p-8 rounded-lg">
					...
					<div class="flex justify-center">
						<button
							type="button"
							class="my-4 mr-5 px-4 bg-purple-800 text-white px-4 py-2 rounded-lg hover:bg-purple-700 focus:outline-none"
